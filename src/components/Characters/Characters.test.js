...
describe('Characters component', () => {
  it('renders characters list correctly', () => {
    ...
    expect(
      getByText('Super soldier and leader of the Avengers.')
    ).toBeInTheDocument()
    ...
    expect(characterImages[0]).toHaveAttribute(
      'src',
      'https://example.com/ironman.jpg'
    )
    expect(characterImages[1]).toHaveAttribute(
      'src',
      'https://example.com/captainamerica.jpg'
    )
